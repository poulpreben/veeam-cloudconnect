...
class Veeam {
  ...
  // Cloud connect magic.
  private $tenant_name            = 'php_rest_test';
  private $tenant_password        = 'lolpassword';
  private $tenant_description     = "Shieeet this is wild";
  ...
  */
   ...
   * @param $xml_data
   */
  private function veeam_create_cloud_tenant($tenant_name = "", $tenant_description = "") {
  ...
  public function run() {
    ...
    $this->backup_server_urn = $this->veeam_get_backup_server('veeam-vbr01');
    $this->backup_server_id  = $this->veeam_get_id_from_urn($this->backup_server_urn);

    $this->backup_repository_urn = $this->veeam_get_backup_repository($this->backup_server_id, 'cc-repo');
    $this->backup_repository_id  = $this->veeam_get_id_from_urn($this->backup_repository_urn);

    echo $this->veeam_create_cloud_tenant("cloudconnect_demouser");
  }
}
